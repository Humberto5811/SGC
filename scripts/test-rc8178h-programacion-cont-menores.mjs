...
ok(lista.etapa_destino === 'COORDINACION_CM', 'J) etapa interna COORDINACION_CM');

ok(lista.etapa_destino_label === 'Cont.Menores', 'etiqueta destino Cont.Menores');

ok(lista.destinos?.[0]?.etapa_label === 'Cont.Menores', 'destinos UI Cont.Menores');
