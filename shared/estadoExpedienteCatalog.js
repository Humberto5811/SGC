...
const ESTADOS_DEF = [
  ...
  { codigo: 'INVITACION_EN_ELABORACION', label: 'Invitación en elaboración', etapa: 'INVITACIONES', prioridad: 400, scope: SCOPE.GLOBAL, familia: 'invitaciones', tipos: ['todos'] },
  {
    ...
    tipos: ['todos'],
    descripcion: 'Situación vigente mientras se esperan respuestas de proveedores (eventos INVITACION_ENVIADA / REINVITACION_ENVIADA)',
  },
...
const ALIAS_MAP = (() => {
  ...
  m.RECIBIDO_POR_ALMACEN = 'BIEN_RECIBIDO_ALMACEN';
