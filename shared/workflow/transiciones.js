...
const DEFS = [
  ...
  // RC8.17.8H5-09B — ruta canónica: Programación → Coordinación CM (no salto directo a Invitaciones).
  ...
  // Reasignación interna dentro de Invitaciones (analista → analista); no ingreso desde CM.
