...
const RCM = ETAPAS.REVISION_COORDINADOR_CM;
const RAM = ETAPAS.REVISION_ANALISTA_CM;
const PEP = ETAPAS.PREPARACION_EXPEDIENTE_PAGO;
...
const DEFS = [
  ...
  [B, P, 'PROGRAMACION_APROBADA', I, true, 'programacion:aprobar', 'COORDINADOR_CM', 'GUARD_APROBAR_PROGRAMACION', null],
  [S, P, 'PROGRAMACION_APROBADA', I, true, 'programacion:aprobar', 'COORDINADOR_CM', 'GUARD_APROBAR_PROGRAMACION', null],
  [L, P, 'PROGRAMACION_APROBADA', I, true, 'programacion:aprobar', 'COORDINADOR_CM', 'GUARD_APROBAR_PROGRAMACION', null],
  [V, P, 'PROGRAMACION_APROBADA', I, true, 'programacion:aprobar', 'COORDINADOR_CM', 'GUARD_APROBAR_PROGRAMACION', 'WORKFLOW_ENGINE_VIATICOS'],
  ...
  [B, P, 'REASIGNACION_RESPONSABLE', P, false, 'programacion:asignar', 'PROGRAMADOR', 'GUARD_ASIGNAR_PROGRAMACION', null],
  [S, P, 'REASIGNACION_RESPONSABLE', P, false, 'programacion:asignar', 'PROGRAMADOR', 'GUARD_ASIGNAR_PROGRAMACION', null],
  [L, P, 'REASIGNACION_RESPONSABLE', P, false, 'programacion:asignar', 'PROGRAMADOR', 'GUARD_ASIGNAR_PROGRAMACION', null],
  [V, P, 'REASIGNACION_RESPONSABLE', P, false, 'programacion:asignar', 'PROGRAMADOR', 'GUARD_ASIGNAR_PROGRAMACION', 'WORKFLOW_ENGINE_VIATICOS'],
  ...
  // RC8.17.8H5 — Cont.Menores opera en etapa funcional INVITACIONES (equipo UAD CONT_MENORES).
  [B, I, 'COORDINACION_CM_OBSERVADA', I, false, 'coordinacion:observar', 'USUARIO_AU', 'GUARD_OBSERVAR_COORDINACION', null],
  [S, I, 'COORDINACION_CM_OBSERVADA', I, false, 'coordinacion:observar', 'USUARIO_AU', 'GUARD_OBSERVAR_COORDINACION', null],
  [L, I, 'COORDINACION_CM_OBSERVADA', I, false, 'coordinacion:observar', 'USUARIO_AU', 'GUARD_OBSERVAR_COORDINACION', null],
  [V, I, 'COORDINACION_CM_OBSERVADA', I, false, 'coordinacion:observar', 'USUARIO_AU', 'GUARD_OBSERVAR_COORDINACION', 'WORKFLOW_ENGINE_VIATICOS'],
  [B, I, 'COORDINACION_CM_SUBSANADA', I, false, 'coordinacion:subsanar', 'COORDINADOR_CM', 'GUARD_SUBSANAR_COORDINACION', null],
  [S, I, 'COORDINACION_CM_SUBSANADA', I, false, 'coordinacion:subsanar', 'COORDINADOR_CM', 'GUARD_SUBSANAR_COORDINACION', null],
  [L, I, 'COORDINACION_CM_SUBSANADA', I, false, 'coordinacion:subsanar', 'COORDINADOR_CM', 'GUARD_SUBSANAR_COORDINACION', null],
  [V, I, 'COORDINACION_CM_SUBSANADA', I, false, 'coordinacion:subsanar', 'COORDINADOR_CM', 'GUARD_SUBSANAR_COORDINACION', 'WORKFLOW_ENGINE_VIATICOS'],
  [B, I, 'COORDINACION_CM_ASIGNADA', I, false, 'coordinacion:asignar', 'COORDINADOR_CM', 'GUARD_ASIGNAR_COORDINACION', null],
  [S, I, 'COORDINACION_CM_ASIGNADA', I, false, 'coordinacion:asignar', 'COORDINADOR_CM', 'GUARD_ASIGNAR_COORDINACION', null],
  [L, I, 'COORDINACION_CM_ASIGNADA', I, false, 'coordinacion:asignar', 'COORDINADOR_CM', 'GUARD_ASIGNAR_COORDINACION', null],
  [V, I, 'COORDINACION_CM_ASIGNADA', I, false, 'coordinacion:asignar', 'COORDINADOR_CM', 'GUARD_ASIGNAR_COORDINACION', 'WORKFLOW_ENGINE_VIATICOS'],
  [B, I, 'COORDINACION_CM_APROBADA', I, true, 'coordinacion:aprobar', 'ESPECIALISTA_CONTRATACIONES', 'GUARD_APROBAR_COORDINACION', null],
  [S, I, 'COORDINACION_CM_APROBADA', I, true, 'coordinacion:aprobar', 'ESPECIALISTA_CONTRATACIONES', 'GUARD_APROBAR_COORDINACION', null],
  [L, I, 'COORDINACION_CM_APROBADA', I, true, 'coordinacion:aprobar', 'ESPECIALISTA_CONTRATACIONES', 'GUARD_APROBAR_COORDINACION', null],
  [V, I, 'COORDINACION_CM_APROBADA', I, true, 'coordinacion:aprobar', 'ESPECIALISTA_CONTRATACIONES', 'GUARD_APROBAR_COORDINACION', 'WORKFLOW_ENGINE_VIATICOS'],
  ...
  [S, PE, 'ENTREGABLE_DERIVADO_COORDINADOR_CM', RCM, true, 'entregables:derivar_coordinador', 'COORDINADOR_CM', 'GUARD_DERIVAR_COORDINADOR_CM', null],
  [L, PE, 'ENTREGABLE_DERIVADO_COORDINADOR_CM', RCM, true, 'entregables:derivar_coordinador', 'COORDINADOR_CM', 'GUARD_DERIVAR_COORDINADOR_CM', null],
  [S, RCM, 'ENTREGABLE_OBSERVADO_COORDINADOR_CM', PE, true, 'entregables:observar_coordinador', 'AREA_USUARIA', 'GUARD_OBSERVAR_COORDINADOR_CM', null],
  [L, RCM, 'ENTREGABLE_OBSERVADO_COORDINADOR_CM', PE, true, 'entregables:observar_coordinador', 'AREA_USUARIA', 'GUARD_OBSERVAR_COORDINADOR_CM', null],
  [S, RCM, 'ENTREGABLE_DERIVADO_ANALISTA_CM', PEP, true, 'entregables:derivar_analista', 'ANALISTA_CONTRATACIONES', 'GUARD_DERIVAR_ANALISTA_CM', null],
  [L, RCM, 'ENTREGABLE_DERIVADO_ANALISTA_CM', PEP, true, 'entregables:derivar_analista', 'ANALISTA_CONTRATACIONES', 'GUARD_DERIVAR_ANALISTA_CM', null],
  [S, RAM, 'ENTREGABLE_OBSERVADO_ANALISTA_CM', PE, true, 'entregables:observar_analista', 'AREA_USUARIA', 'GUARD_OBSERVAR_ANALISTA_CM', null],
  [L, RAM, 'ENTREGABLE_OBSERVADO_ANALISTA_CM', PE, true, 'entregables:observar_analista', 'AREA_USUARIA', 'GUARD_OBSERVAR_ANALISTA_CM', null],
  [S, PEP, 'ENTREGABLE_OBSERVADO_ANALISTA_CM', PE, true, 'entregables:observar_analista', 'AREA_USUARIA', 'GUARD_OBSERVAR_ANALISTA_CM', null],
  [L, PEP, 'ENTREGABLE_OBSERVADO_ANALISTA_CM', PE, true, 'entregables:observar_analista', 'AREA_USUARIA', 'GUARD_OBSERVAR_ANALISTA_CM', null],
  [S, RAM, 'ENTREGABLE_DERIVADO_PAGO', DP, true, 'pago:derivar', 'ANALISTA_PAGO', 'GUARD_DERIVAR_PAGO', null],
  [L, RAM, 'ENTREGABLE_DERIVADO_PAGO', DP, true, 'pago:derivar', 'ANALISTA_PAGO', 'GUARD_DERIVAR_PAGO', null],
  [S, PEP, 'ENTREGABLE_DERIVADO_PAGO', DP, true, 'pago:derivar', 'ANALISTA_PAGO', 'GUARD_DERIVAR_PAGO', null],
  [L, PEP, 'ENTREGABLE_DERIVADO_PAGO', DP, true, 'pago:derivar', 'ANALISTA_PAGO', 'GUARD_DERIVAR_PAGO', null],
