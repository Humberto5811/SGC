...
const DEFS = [
  ...
  [S, RCM, 'ENTREGABLE_DERIVADO_ANALISTA_CM', RAM, true, 'entregables:derivar_analista', 'ANALISTA_CONTRATACIONES', 'GUARD_DERIVAR_ANALISTA_CM', null],
  [L, RCM, 'ENTREGABLE_DERIVADO_ANALISTA_CM', RAM, true, 'entregables:derivar_analista', 'ANALISTA_CONTRATACIONES', 'GUARD_DERIVAR_ANALISTA_CM', null],
  [S, RAM, 'ENTREGABLE_OBSERVADO_ANALISTA_CM', RCM, true, 'entregables:observar_analista', 'COORDINADOR_CM', 'GUARD_OBSERVAR_ANALISTA_CM', null],
  [L, RAM, 'ENTREGABLE_OBSERVADO_ANALISTA_CM', RCM, true, 'entregables:observar_analista', 'COORDINADOR_CM', 'GUARD_OBSERVAR_ANALISTA_CM', null],
