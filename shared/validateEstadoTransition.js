...
const TRANSICIONES_PERMITIDAS = Object.freeze({
  ...
  PROGRAMACION_APROBADA: ['INVITACION_EN_ELABORACION', 'INVITACION_ENVIADA', 'EN_COORDINACION_CM'],
  ...
  INVITACION_EN_ELABORACION: ['INVITACION_ENVIADA', 'ESPERANDO_COTIZACIONES'],
  INVITACION_ENVIADA: ['ESPERANDO_COTIZACIONES', 'COTIZACIONES_RECIBIDAS', 'VALIDACION_ENVIADA', 'CUADRO_BORRADOR', 'PENDIENTE_ELABORAR'],
  ESPERANDO_COTIZACIONES: ['COTIZACIONES_RECIBIDAS', 'VALIDACION_ENVIADA', 'CUADRO_BORRADOR', 'PENDIENTE_ELABORAR', 'INVITACION_ENVIADA'],
