...
export function buildObservacionEntry(payload, fields = {}) {
  ...
  return {
    ...
    destino_derivacion_submodulo: fields.destino_derivacion_submodulo || fields.destinoDerivacionSubmodulo || '',
    destino_derivacion_etapa: fields.destino_derivacion_etapa || fields.destinoDerivacionEtapa || '',
    usuario_origen_id: fields.usuario_origen_id ?? fields.usuarioOrigenId ?? null,
    usuario_destino_id: fields.usuario_destino_id ?? fields.usuarioDestinoId ?? null,
    responsable_recomendado_id: fields.responsable_recomendado_id ?? null,
    reasignacion_manual: fields.reasignacion_manual === true,
